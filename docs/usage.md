...
<img width="230" height="250" alt="Blank cube" src="https://raw.githubusercontent.com/Altarok/RubikCubeAlgoView/master/screenshots/PllCubeExample_1_Blank_230x250.png"/>
</details>
</div>
...
| arrows       | Displays arrows between stickers.              | See below                | `arrows:1+3,2+8`   | n/a                  |
| flags        | Use for special options.                       | no-buttons               | `flags:no-buttons` | n/a                  |
...
This snippet would create a cube with normal arrows:
...
<details>
<summary>Expand for screenshot</summary>
<img width="230" height="250" alt="Blank cube" src="https://raw.githubusercontent.com/Altarok/RubikCubeAlgoView/master/screenshots/PllCubeExample_3_SingleArrows_230x250.png"/>
</details>
</div>
...
This snippet would create a cube with double-sided arrows:
````
```rubikCubePLL
arrows:3+9,4+6
```
...
<details>
<summary>Expand for screenshot</summary>
<img width="230" height="250" alt="Cube with double-sided arrows" src="https://raw.githubusercontent.com/Altarok/RubikCubeAlgoView/master/screenshots/PllCubeExample_4_DoubleSidedArrows_230x250.png"/>
</details>
</div>
...
This snippet would create a cube with chained arrows:
````
```rubikCubePLL
arrows:1-3-7
```
...
<details>
<summary>Expand for screenshot</summary>
<img width="230" height="250" alt="Cube with chained arrows" src="https://raw.githubusercontent.com/Altarok/RubikCubeAlgoView/master/screenshots/PllCubeExample_5_ChainedArrows_230x250.png"/>
</details>
</div>
...
This snippet would create cube with alt colors:
````
```rubikCubePLL
